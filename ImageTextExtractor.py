...
class ImageTextExtractor:
    def __init__(self, image_list, column_num):
        ...
        self.image_extracted_data_list = self.process_pdf(
            self.images, self.column_num)

    def process_pdf(self, images, column_num):
        start = time.time()
        ...
        if self.column_num in column_functions:
            ...
            for i, image in enumerate(self.images):
                ...
                extracted_data_list.append(line_formatted)
        else:
...
if __name__ == "__main__":
    extractor = ImageTextExtractor("./test/Meeting Minute3.pdf", 2)
